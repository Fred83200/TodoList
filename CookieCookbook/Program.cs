...
var stringsRepository = Format == FileFormat.Json ? new StringsJsonRepository() : new StringsTextualRepository();
...
public class CookiesRecipesApp
{
    ...
    public void Run(string filePath)
    {
        ...
        {
            _recipesUserInteraction.ShowMessage("No ingredients have been selected. The recipe will not be saved.");
        }
...
public class RecipesConsolUserInteraction : IRecipesUserInteraction
{
    private readonly IIngredientsRegister _ingredientsRegister;

    public RecipesConsolUserInteraction(IIngredientsRegister ingredientsRegister)
    {
    ...
    {
        Console.WriteLine("Create a new cookie recipe! " + "The available ingredients are:");
